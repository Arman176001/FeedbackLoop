...
const HomePageBG = () => {
  return (
    <div className="-z-10">
      <div className="flex">
        <div className="bg-gradient-to-r from-[#ffffff] to-[#FFF57C] w-[65%] h-screen "></div>
        <div className="relative flex flex-col w-[35%] justify-center items-center">
          <div className="relative top-10">
            ...
            <div className="relative bg-gradient-to-t from-[#ffc14fbf] to-[#fca7ffbf] w-[286px] h-[286px] rounded-full -z-5"></div>
